...
INTERFACE /dmo/if_flight_legacy04
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL04
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel04     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING04
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking04    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_04
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_04 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT04
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight04 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id04.
  ...
  TYPES booking_id TYPE /dmo/booking_id04.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id04.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL04, /DMO/BOOKING04, /DMO/BOOK_SUP_04 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code04.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code04,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status04,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel04_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id04.
  INCLUDE TYPE /dmo/booking04_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id04.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id04.
  INCLUDE TYPE /dmo/book_sup_04_data.
