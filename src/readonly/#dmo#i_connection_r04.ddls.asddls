@AbapCatalog.sqlViewName: '/DMO/ICONNE_R04'
...
define view /DMO/I_Connection_R04
  as select from /dmo/connecti_04 as Connection

  association [1..*] to /DMO/I_Flight_R04 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier04  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport04',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
